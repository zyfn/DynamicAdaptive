...
# -----data related-----
data_root = 'data/uav/'  # Root path of data
# Path of train annotation file
train_ann_file = 'annotations/train.json'
train_data_prefix = 'trainImages/'  # Prefix of train image path
# Path of val annotation file
val_ann_file = 'annotations/val.json'
val_data_prefix = 'valImages/'  # Prefix of val image path
...
#################################################################
    # base_lr=base_lr_default * (your_bs / default_bs)
base_lr = 0.01
load_from='yolov8_s_syncbn_fast_8xb16-500e_coco_20230117_180101-5aa5f0f1.pth'
...
# -----data related-----
# img_scale = (960, 800)  # width, height
# img_scale = (4096,2144)  # width, height
# img_scale = (2560,1440)  
# img_scale = (1920,1056)  
img_scale = (640,640)
